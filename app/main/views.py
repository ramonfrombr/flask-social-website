...
from flask import abort, flash, make_response, render_template, session, redirect, url_for, current_app, request
...
def followers(username):
  ...
  pagination = user.followers.paginate(
      page=page, per_page=current_app.config['APP_FOLLOWERS_PER_PAGE'],
      error_out=False
  )
